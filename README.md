[![Docker Repository on Quay](https://quay.io/repository/giantswarm/pv-cleaner-operator/status "Docker Repository on Quay")](https://quay.io/repository/giantswarm/pv-cleaner-operator)
# pv-cleaner-operator
